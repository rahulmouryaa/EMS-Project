...
const FailedTask = () => {
  return (
    ...
    <div className="flex justify-between items-center">
      <h3 className="bg-red-600 text-white text-sm px-4 py-1 rounded-lg font-medium">{data.category}</h3>
    ...
    <div className="flex justify-between mt-6 space-x-4">
      <button className="bg-red-500 text-white rounded-lg font-medium py-2 px-6 text-sm shadow-md hover:bg-red-700 hover:shadow-lg transition duration-300">
        Mark as Failed
      </button>
    </div>
  </div>
