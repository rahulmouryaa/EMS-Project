...
const CompleteTask = ({data}) => {
  return (
    ...
    <div className="flex justify-between items-center">
      <h3 className="bg-green-600 text-white text-sm px-4 py-1 rounded-lg font-medium">{data.category}</h3>
    ...
    <div className="flex justify-between mt-6 space-x-4">
      <button className="bg-green-500 text-white rounded-lg font-medium py-2 px-6 text-sm shadow-md hover:bg-green-700 hover:shadow-lg transition duration-300">
        Completed Task
      </button>
    </div>
  </div>
